...
- NATS JetStream integration (#58)
- Introduce `rhio-core` and `rhio-client` crates for client development (#57)
- Configuration interface (#53)
- Support for MinIO storage (#47)
- Experimental FFI bindings for Python (#37)
